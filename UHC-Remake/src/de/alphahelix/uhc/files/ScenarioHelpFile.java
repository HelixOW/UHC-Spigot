...
public class ScenarioHelpFile extends EasyFile {
	...
	public void addValues() {
		setDefault("ScenarioName (please use the real scenario name not your edited ones!)", "Put in your description of the scenario here. See all english descriptions here:[] To make a new line please add [nl]");
