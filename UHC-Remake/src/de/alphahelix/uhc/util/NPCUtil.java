...
public class NPCUtil extends Util {
	...
	private Object pPOEntityHeadRotation;
	private Object pPOEntityLook;

	public NPCUtil(UHC uhc) {
		super(uhc);
	}

	public Object prepareNPC(Location loc, OfflinePlayer skin, Player toSend) {
		try {
			...
			pPOEntityHeadRotation = ReflectionUtil.getNmsClass("PacketPlayOutEntityHeadRotation")
					.getConstructor(ReflectionUtil.getNmsClass("Entity"), byte.class)
					.newInstance(npc, toAngle(loc.getYaw()));

			pPOEntityLook = ReflectionUtil.getNmsClass("PacketPlayOutEntity$PacketPlayOutEntityLook")
