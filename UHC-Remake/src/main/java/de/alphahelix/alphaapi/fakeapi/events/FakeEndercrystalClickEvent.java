...
import de.alphahelix.alphaapi.fakeapi.instances.FakeEndercrystal;
...
public class FakeEndercrystalClickEvent extends PlayerEvent {

    private static final HandlerList handlers = new HandlerList();
    private FakeEndercrystal fakeArmorstand;
    private REnumAction clickAction;
    private REnumHand hand;

    public FakeEndercrystalClickEvent(Player who, FakeEndercrystal fakeArmorstand, REnumAction clickAction, REnumHand hand) {
        super(who);
