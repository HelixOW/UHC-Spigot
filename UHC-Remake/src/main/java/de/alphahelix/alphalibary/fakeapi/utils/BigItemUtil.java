...
public class BigItemUtil extends UtilBase {
    ...
    public static FakeBigItem spawnBigItem(Player p, Location loc, String name, ItemStack itemStack) {
        try {
            FakeMob fakeGiant = MobUtil.spawnTemporaryMob(p, loc, name, FakeMobType.GIANT);
            ...
            MobUtil.equipMob(p, fakeGiant, itemStack, EquipSlot.HAND);
    ...
    public static FakeBigItem spawnTemporaryBigItem(Player p, Location loc, String name, ItemStack stack) {
        try {
            ...
            MobUtil.equipMob(p, fakeGiant, stack, EquipSlot.HAND);
