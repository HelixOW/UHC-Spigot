...
public class ArmorstandUtil extends UtilBase {
     ...
     */
    public static void equipArmorstand(Player p, FakeArmorstand armorstand, ItemStack item, EquipSlot slot) {
        try {
    ...
    public static void equipArmorstandSkull(Player p, FakeArmorstand armorstand, String textureURL) {
        equipArmorstand(p, armorstand, SkullItemBuilder.getSkull(textureURL), EquipSlot.HELMET);
    }
    ...
    public static void equipArmorstandSkull(Player p, FakeArmorstand armorstand, GameProfile profile) {
        try {
            equipArmorstand(p, armorstand, SkullItemBuilder.getSkull(profile), EquipSlot.HELMET);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
