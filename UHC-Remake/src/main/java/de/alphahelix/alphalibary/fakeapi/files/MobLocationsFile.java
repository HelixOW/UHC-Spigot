...
public class MobLocationsFile extends SimpleFile<FakeAPI> {

    public MobLocationsFile(FakeAPI pl) {
        super("plugins/FakeAPI", "fake_mobs.ht", pl);
    }

    /**
     * Adds a new {@link FakeMob} to the file
     *
     * @param loc         {@link org.bukkit.Location} where the {@link FakeMob} is located at
