...
import de.popokaka.alphalibary.item.data.WrongDataException;
...
public class ItemBuilder {
	 ...
	 * 
	 * @param e
	 *            The enchantment which ItemStack should have then
	 * @param level
	 ...
	 * 
	 * @param name
	 *            The new custom name of the ItemStack
	 */
	 ...
	 * 
	 * @param flagsToRemove
	 *            The ItemFlag you want to remove
	 */
